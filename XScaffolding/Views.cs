...
namespace MYPROJECT.Views
{
	public partial class MyModelForm : ContentPage
	{
		...
		public MyModelForm()
		{
			...
			var entryField = new EntryCell { Label = MYPROJECT.Resources.entryFieldLabel };
			...
			var multiLineEntryFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.multiLineEntryFieldLabel }, multiLineEntryField } } };
			multiLineEntryField.SetBinding(Editor.TextProperty, new Binding("MultiLineEntry", BindingMode.TwoWay, source: Model));

			var textField = new TextCell { Text = MYPROJECT.Resources.textFieldLabel, Detail = Model.Text };

			var switchField = new SwitchCell { Text = MYPROJECT.Resources.switchFieldLabel };
			switchField.SetBinding(SwitchCell.OnProperty, new Binding("Switch", BindingMode.TwoWay, source: Model));

			var pickerField = new Picker { Title = MYPROJECT.Resources.pickerFieldLabel };
			...
			var pickerFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.pickerFieldLabel }, pickerField } } };
			...
			var sliderFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.sliderFieldLabel }, sliderField } } };
			...
			var stepperFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.stepperFieldLabel }, stepperField } } };
			...
			var dateFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.dateFieldLabel }, dateField } } };
			...
			var timeFieldView = new ViewCell { View = new StackLayout { Children = { new Label { Text = MYPROJECT.Resources.timeFieldLabel }, timeField } } };
